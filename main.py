...
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  1️⃣  {Colors.SOFT_PINK} Inventory Management   📦                                         {Colors.RESET}                           
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  2️⃣  {Colors.SOFT_PINK} Order Processing       🛒                                         {Colors.RESET}                           
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  3️⃣  {Colors.SOFT_PINK} Warehouse Locations    🗺️                                         {Colors.RESET}                           
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  4️⃣  {Colors.SOFT_PINK} Reports                📝                                         {Colors.RESET}                           
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  5️⃣  {Colors.SOFT_PINK} User Management        👥                                         {Colors.RESET}                           
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  6️⃣  {Colors.SOFT_PINK} Receiving Goods        🚚                                         {Colors.RESET}                           
{Colors.SOFT_GREEN}{Colors.ORQA_qora}  7️⃣  {Colors.SOFT_PINK} Exit                   🔚                                         {Colors.RESET}                           
{Colors.ORQA_qora}🌟                                                                     🌟{Colors.RESET}
{Colors.ORQA_qora}🌟                                                                     🌟{Colors.RESET}
{Colors.SOFT_PURPLE}═════════════════════════════════════════════════════════════════════════{Colors.RESET}"""
